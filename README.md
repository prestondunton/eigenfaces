...
## Note
When viewing Eigenfaces.ipynb, some of the LaTex in the Calculating Eigenvectors section is missing, for an unknown reason.  If you want to see the proof as to why $$S$$ and $$A^TA$$, look in Eigenfaces.pdf.
